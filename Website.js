...
// ===== Shows (Monatswechsel) =====
const shows = [
  { date: "2026-03-21", location: "Bamberg KUFA, Benefizkonzert zu gunsten der - Inklusion durch Kultur e.V. - (Lebenshilfe Bamberg)", time: "Einlass: 18:45 Uhr Beginn: 19:30 Uhr", address: "Kellerstraße 3, 96049 Bamberg", tickets: "https://ticketlink.de"  },
  { date: "2026-05-02", location: "Hallstad Fäsla Stubn", time: "Uhrzeit wird noch bekannt gegeben", address: "Marktplatz 3 · 96103 Hallstadt" },
  { date: "2026-05-14", location: "Oberhaid Feuerwehr", time: "Uhrzeit wird noch bekannt gegeben", address: "Blumenstraße 6, 96173 Oberhaid" },
  { date: "2026-06-04", location: "Hallstadt Feuerwehr", time: "Uhrzeit wird noch bekannt gegeben", address: "An der Feuerwehr 1, 96103 Hallstadt" },
  ...
  { date: "2026-07-13", location: "Roßdorf am Forst Kirchweih", time: "Uhrzeit wird noch bekannt gegeben", address: "Sutte 5, 96129 Strullendorf - Roßdorf" },
  { date: "2026-07-19", location: "Bamberg Wunderburger Kirchweih", time: "Star: 17:00 Uhr Ende:21:00 Uhr + Zugabe", address: "Wunderburg 6, 96050 Bamberg" },
  { date: "2026-07-25", location: "Trosdorf Stichelfest", time: "Uhrzeit wird noch bekannt gegeben", address: "Ort wird noch bekannt gegeben" },
  { date: "2026-07-27", location: "Hallstadt Anna Kirchweih", time: "Uhrzeit wird noch bekannt gegeben", address: "SV Hallstadt am Sportplatz, 96103 Hallstadt" },
  { date: "2026-08-08", location: "Bamberg Laurenzikirchweih - Brauerei Greifenklau", time: "Uhrzeit wird noch bekannt gegeben", address: "Laurenziplatz 20, 96049 Bamberg" },
  { date: "2026-08-09", location: "Bamberg Laurenzikirchweih - Brauerei Greifenklau", time: "Uhrzeit wird noch bekannt gegeben", address: "Laurenziplatz 20, 96049 Bamberg" },
  ...
  { date: "2026-10-17", location: "Hirschaid Schützen Proklamation", time: "Uhrzeit wird noch bekannt gegeben", address: "Nürnberger Str. 96 -100, 96114 Hirschaid" },
];
